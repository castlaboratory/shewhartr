...
.shewhart_messages <- list(
  en = list(
    ...
    word_phase            = "phase",
    word_phases           = "phases",
    word_violation        = "violation",
    word_violations       = "violations",
  ...
  pt = list(
    ...
    word_phase            = "fase",
    word_phases           = "fases",
    word_violation        = "viola\u00e7\u00e3o",
    word_violations       = "viola\u00e7\u00f5es",
    cusum_positive        = "Positivo",
    cusum_negative        = "Negativo",
  ...
  es = list(
    ...
    word_phase            = "fase",
    word_phases           = "fases",
    word_violation        = "violaci\u00f3n",
    word_violations       = "violaciones",
    cusum_positive        = "Positivo",
    cusum_negative        = "Negativo",
  ...
  fr = list(
    ...
    word_violation        = "violation",
    word_violations       = "violations",
    cusum_positive        = "Positif",
    cusum_negative        = "N\u00e9gatif",
