...
the WE 7-same rule, ARL_0 is $2^7 - 1 = 127$ — phase changes are detected
...
based on the maximum-likelihood lambda: `log` when
$\hat\lambda < 0.25$, `linear` otherwise (a square-root lambda near
0.5 maps to `linear`; `loglog` is stronger than `log` and is never
chosen automatically). It is a good first try when you don't have
strong prior knowledge of the functional form.
...
* Perla, R. J., Provost, S. M., Parry, G. J., Little, K., & Provost,
  ...
  doi:10.1093/intqhc/mzaa069. — the three-phase
...
* Ferraz, C., Petenate, A. J., Leite Wanderley, A., Ospina, R.,
  ...
  *Anais do LII Simpósio Brasileiro de Pesquisa Operacional*
  (SBPO 2020), João Pessoa-PB. — the Brazilian
